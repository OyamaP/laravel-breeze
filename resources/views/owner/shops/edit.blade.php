                ...
                <div class="p-6 bg-white border-b border-gray-200">
                    ...
                    <form method="post" action="{{ route('owner.shops.update', ['shop' => $shop->id]) }}" enctype="multipart/form-data">
                        ...
                        <div class="-m-2">
                            ...
                            <div class="p-2 w-1/2 mx-auto">
                                <div class="relative">
                                    <label for="information" class="leading-7 text-sm text-gray-600">Information ※required</label>
                            ...
                            <div class="p-2 w-1/2 mx-auto">
                             ...
                             <div class="p-2 w-1/2 mx-auto">
                                <div class="relative flex justify-around">
                                    <div class="flex items-center"><input type="radio" id="is_selling" name="is_selling" value="1" class="mr-2" @if($shop->is_selling === 1) checked @endif >Now on sale</div>
                                    <div class="flex items-center"><input type="radio" id="is_selling" name="is_selling" value="0" class="mr-2" @if($shop->is_selling === 0) checked @endif >Stopped</div>
                                </div>
                             </div>
